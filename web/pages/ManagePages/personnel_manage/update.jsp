        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">更新用户</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<script>
    ...
    ori_class_name = document.getElementById("person_update").className;
    document.getElementById("person_update").className = ori_class_name + " active";
</script>
